#install.packages(c("robumeta", "metafor"))
...
# Use the following the command to load the data. You are creating a new object called "dat" from the Molloy et al., (2014) data.
